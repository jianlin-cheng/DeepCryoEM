...
% output folder
clust_output_dir='C:\Users\Adil Al-Azzawi\Desktop\Protein Project\Single Particle Picking\Expermental Results\K-means Clustering Images\';
%
...
D = dir('*.tif');
    for n = 1:numel(D)
        ...
        % Clustering 
        cd(code_dir); 
        cluster_image = K_means_Clustering(J2);
        time=toc;
        k_means_time(n)=toc;
...
disp('All the MRI brain tumor images have been done (Clustred using K-means) ...');
