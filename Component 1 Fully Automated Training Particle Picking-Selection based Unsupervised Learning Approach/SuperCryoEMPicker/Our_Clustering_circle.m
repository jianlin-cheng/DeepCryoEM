function [cluster_image] = Our_Clustering_circle(im)
...
%%
% cluster_image=cluster_3+cluster_4;
% [cluster_image] = Multiple_Level_Image_Fuxion(cluster_3,cluster_4);
% figure; imshow(cluster_3);
% cluster1=bwareaopen(cluster_3,100);
